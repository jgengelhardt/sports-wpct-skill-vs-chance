...
leagues = (NHL_history, NBA_history, WNBA_history, NFL_history)
colors = ('#000000', '#C9082A','#FA8320', '#013369')
groups = ('NHL','NBA', 'WNBA', 'NFL')

# plot data grouped by league
for league, color, group in zip(leagues, colors, groups):
    x,y = zip(*league)
    plt.scatter(x, y, c=color, alpha=0.5, label=group)
